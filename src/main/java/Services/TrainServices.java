...
public class TrainServices {
    ...
    private static final String TRAIN_DB_PATH = "C:\\Users\\avish\\OneDrive\\Desktop\\Selenium course\\Ticket-booking\\src\\main\\java\\LocalDB\\trains.json";
    ...
    public HashMap<Integer,String> searchTrains(String source, String destination) {

        localDb.CreateConnection();
        return localDb.searchStations(source,destination);
